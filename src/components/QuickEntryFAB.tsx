...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  { type: 'transaction', label: 'Финансы', icon: DollarSign, color: 'text-yellow-400', bg: 'bg-yellow-500/20' },
  { type: 'note', label: 'Заметка', icon: StickyNote, color: 'text-purple-400', bg: 'bg-purple-500/20' },
]
      ...
      <Dialog open={activeEntry === 'weight'} onOpenChange={() => setActiveEntry(null)}>
        <DialogContent className="max-w-xs">
          ...
          <div className="space-y-3 pt-2">
            ...
            <Button className="w-full bg-primary" onClick={handleSaveWeight} disabled={!weight || isSaving}>
      ...
      <Dialog open={activeEntry === 'food'} onOpenChange={() => setActiveEntry(null)}>
        <DialogContent className="max-w-xs">
          ...
          <div className="space-y-3 pt-2">
            ...
            <Button className="w-full bg-primary" onClick={handleSaveFood} disabled={!foodName || isSaving}>
      ...
      <Dialog open={activeEntry === 'note'} onOpenChange={() => setActiveEntry(null)}>
        <DialogContent className="max-w-xs">
          ...
          <div className="space-y-3 pt-2">
            ...
            <Button className="w-full bg-primary" onClick={handleSaveNote} disabled={!noteText.trim() || isSaving}>
              {isSaving ? 'Сохранение...' : 'Сохранить'}
            </Button>
          </div>
        </DialogContent>
