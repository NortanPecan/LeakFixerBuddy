...
export function ChallengesScreen() {
  ...
  useEffect(() => {
    const loadChallenges = async () => {
      ...
      try {
        ...
        showErrorToast(err, 'загрузка челенджей')
  ...
  const handleCreateChallenge = async () => {
    ...
    try {
      ...
      showSuccessToast('Челендж создан')
    } catch (error) {
      showErrorToast(error, 'создание челенджа')
    }
  }
  ...
  const handleDeleteChallenge = async (id: string) => {
    try {
      ...
      showSuccessToast('Челендж удалён')
    } catch (error) {
      showErrorToast(error, 'удаление челенджа')
    }
  }
