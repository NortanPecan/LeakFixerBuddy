...
function MorningCheckin({
  ...
  return (
    <>
      <DialogHeader>
        <div className="text-xs text-white/40 uppercase tracking-widest mb-1">Утренний чекап</div>
      ...
      <div className="space-y-5 py-2">
        ...
        {step === 0 && (
          <div className="space-y-4">
            <div className="text-center">
              <div className="text-5xl font-black text-white mb-1">{data.energy}</div>
        ...
        {step === 2 && (
          <div className="space-y-3">
            <p className="text-xs text-white/50">Мысль или намерение которое хочешь помнить весь день</p>
            <Textarea
...
function EveningCheckin({
  ...
  return (
    <>
      <DialogHeader>
        <div className="text-xs text-white/40 uppercase tracking-widest mb-1">Вечерний чекап</div>
        <DialogTitle className="text-white text-xl">
      ...
      <div className="space-y-5 py-2">
        ...
        {step === 0 && (
          <div className="space-y-4">
            <div className="text-center">
              <div className="text-5xl font-black text-white mb-1">{data.dayRating}</div>
            ...
            {data.dayRating <= 4 && (
              <div className="space-y-2">
                <label className="text-xs text-amber-400/80">Рейфрейминг — что хорошего всё равно было?</label>
                <Textarea
                  placeholder="Даже в плохом дне есть маленькие победы..."
                  value={data.reframe}
                  onChange={e => onChange({ ...data, reframe: e.target.value })}
                  className="bg-amber-500/5 border-amber-500/20 text-white placeholder:text-white/30 min-h-[80px] resize-none"
                />
              </div>
            )}
          </div>
            ...
            {tasks.length > 0 ? (
              <>
                ...
                {tasks.map(({ key, label }) => (
                  ...
                  >
                    <div
                      className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-sm transition-all"
                      style={{
                    ...
                    <span className={`text-sm ${data[key] ? 'text-green-400 line-through opacity-70' : 'text-white'}`}>
                      {label}
                    </span>
                  </button>
                ))}
              ...
              <div className="space-y-2">
                <p className="text-xs text-white/50">Что сделал сегодня? (утренние задачи не были заполнены)</p>
                <Textarea
