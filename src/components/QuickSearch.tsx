      ...
      >
          ...
          {activeAction ? (
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-lg px-4 text-sm font-medium transition-all disabled:opacity-40"
                  style={{
            ...
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                className="h-10 flex-1 border-0 bg-transparent p-0 text-base text-white placeholder:text-white/30 focus-visible:ring-0"
                autoFocus
              />
              {query && (
                <button className="text-white/30 hover:text-white/60" onClick={() => setQuery("")}>
                  ✕
                </button>
              )}
            </div>
          ...
          <div className="max-h-72 overflow-y-auto py-1">
            {filtered.length === 0 ? (
              ...
              filtered.map((action) => (
                ...
                >
                  <span className="w-8 text-center text-xl">{action.emoji}</span>
                  ...
                  {action.type === "navigate" ? (
                    ...
                    <span className="text-xs text-indigo-400/60">+ добавить</span>
                  )}
                </button>
              ))
            )}
        ...
        {!activeAction && (
          <div className="border-t border-white/5 px-4 py-2">
            <p className="text-center text-xs text-white/20">Быстрый ввод без навигации</p>
          </div>
        )}
      </DialogContent>
    </Dialog>
