...
import { Plus, Edit2, Trash2, GripVertical, Palette, MapPin } from "lucide-react";
  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-4 pb-20">
        <h1 className="text-foreground text-2xl font-bold">Зоны</h1>
        <Card className="bg-card/50 backdrop-blur">
          <CardContent className="pt-6">
            <div className="text-muted-foreground text-center">Загрузка...</div>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <Card className="bg-card/50 backdrop-blur">
        ...
        <CardContent>
          {zones.filter((z) => z.isActive).length > 0 ? (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-xs">{zone.key}</p>
                      </div>
                      {zone.isDefault && (
            ...
            <div className="text-muted-foreground py-4 text-center">Нет активных зон</div>
          )}
        </CardContent>
      </Card>
            ...
            <div className="space-y-2">
              {zones
                ...
                .map((zone) => (
                  <div
                    key={zone.id}
                    className="bg-muted/20 group flex items-center justify-between rounded-lg p-3 opacity-60"
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-2xl">{zone.emoji || "📁"}</span>
                      <div>
                    ...
                    <Button variant="outline" size="sm" onClick={() => handleToggleActive(zone)}>
                      Показать
                    </Button>
                  </div>
                ))}
          ...
          <div className="space-y-4 pt-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setEditingZone((prev) => (prev ? { ...prev, name: e.target.value } : null))
                }
              />
            </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingZone((prev) =>
                      prev
                        ? { ...prev, key: e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, "_") }
                        : null
                    )
                  }
                />
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setEditingZone((prev) => (prev ? { ...prev, isActive: checked } : null))
                }
              />
            </div>
            <div className="flex gap-2">
              ...
              <Button className="bg-primary flex-1" onClick={handleUpdateZone} disabled={saving}>
