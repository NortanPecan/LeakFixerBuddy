      ...
      <div className="flex flex-col gap-4 pb-20">
        ...
        <Card className="bg-card/50 backdrop-blur">
          <CardContent className="pt-4 text-center">
            ...
            <Button variant="outline" className="mt-4" onClick={() => setScreen("development")}>
    ...
    <div className="flex flex-col gap-4 pb-20">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1">
          <h1 className="line-clamp-1 text-xl font-bold">{item.title}</h1>
          <p className="text-muted-foreground text-sm">{typeInfo.label}</p>
        </div>
      ...
      {isEditing ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditData((prev) => ({
                      ...prev,
                      currentUnits: parseInt(e.target.value) || 0,
                    }))
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditData((prev) => ({ ...prev, totalUnits: parseInt(e.target.value) || 0 }))
                  }
                />
              </div>
            </div>
        ...
        <>
          ...
          {/* Author & Source */}
          {item.author && <p className="text-muted-foreground text-sm">👤 {item.author}</p>}
          {item.source && <p className="text-muted-foreground text-sm">📍 {item.source}</p>}
          ...
          {item.links && item.links.length > 0 && (
            <div className="space-y-2">
              {item.links.map((link) => (
                <div
                  key={link.id}
                  className="bg-muted/30 hover:bg-muted/50 cursor-pointer rounded-lg p-3 text-sm"
          ...
          {item.tasks && item.tasks.length > 0 && (
            <div className="space-y-2">
              {item.tasks.map((task) => (
                <div
                  key={task.id}
                  className="bg-muted/30 hover:bg-muted/50 flex cursor-pointer items-center gap-2 rounded-lg p-3 text-sm"
      ...
      <Card className="bg-card/50 backdrop-blur">
        <CardContent className="space-y-3 p-4">
            ...
            <div className="space-y-2">
              {item.rituals.map((ritual) => (
                ...
                >
                  ...
                  <Badge
                    variant={ritual.status === "active" ? "default" : "secondary"}
                    className="text-[10px]"
                  >
          ...
          <Button variant="outline" size="sm" className="w-full gap-1" onClick={openRitualModal}>
            <Sparkles className="h-4 w-4" />
            Создать ритуал
          </Button>
        </CardContent>
      ...
      {/* Delete button */}
      <Button variant="destructive" className="w-full gap-1" onClick={handleDelete}>
      ...
      <Dialog open={showRitualModal} onOpenChange={setShowRitualModal}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="bg-muted/30 text-muted-foreground rounded-lg p-3 text-sm">
