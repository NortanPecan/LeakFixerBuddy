...
const FitnessScreen = lazy(() =>
  import("@/components/screens/FitnessScreen").then((m) => ({ default: m.FitnessScreen }))
);
const GymScreen = lazy(() =>
  import("@/components/screens/GymScreen").then((m) => ({ default: m.GymScreen }))
);
const RitualsScreen = lazy(() =>
  import("@/components/screens/RitualsScreen").then((m) => ({ default: m.RitualsScreen }))
);
const CreateRitualScreen = lazy(() =>
  import("@/components/screens/CreateRitualScreen").then((m) => ({ default: m.CreateRitualScreen }))
);
const CatalogScreen = lazy(() =>
  import("@/components/screens/CatalogScreen").then((m) => ({ default: m.CatalogScreen }))
);
...
const ChainDetailScreen = lazy(() =>
  import("@/components/screens/ChainDetailScreen").then((m) => ({ default: m.ChainDetailScreen }))
);
const CreateTaskScreen = lazy(() =>
  import("@/components/screens/CreateTaskScreen").then((m) => ({ default: m.CreateTaskScreen }))
);
const CreateChainScreen = lazy(() =>
  import("@/components/screens/CreateChainScreen").then((m) => ({ default: m.CreateChainScreen }))
);
const NotesScreen = lazy(() =>
  import("@/components/screens/NotesScreen").then((m) => ({ default: m.NotesScreen }))
);
const DevelopmentScreen = lazy(() =>
  import("@/components/screens/DevelopmentScreen").then((m) => ({ default: m.DevelopmentScreen }))
);
const ContentDetailScreen = lazy(() =>
  import("@/components/screens/ContentDetailScreen").then((m) => ({
    default: m.ContentDetailScreen,
  }))
);
const FinanceScreen = lazy(() =>
  import("@/components/screens/FinanceScreen").then((m) => ({ default: m.FinanceScreen }))
);
const ChallengesScreen = lazy(() =>
  import("@/components/screens/ChallengesScreen").then((m) => ({ default: m.ChallengesScreen }))
);
const ChallengeDetailScreen = lazy(() =>
  import("@/components/screens/ChallengeDetailScreen").then((m) => ({
    default: m.ChallengeDetailScreen,
  }))
);
const HealthScreen = lazy(() =>
  import("@/components/screens/HealthScreen").then((m) => ({ default: m.HealthScreen }))
);
const DailySummaryScreen = lazy(() =>
  import("@/components/screens/DailySummaryScreen").then((m) => ({ default: m.DailySummaryScreen }))
);
const GoalsScreen = lazy(() =>
  import("@/components/screens/GoalsScreen").then((m) => ({ default: m.GoalsScreen }))
);
const SkillsScreen = lazy(() =>
  import("@/components/screens/SkillsScreen").then((m) => ({ default: m.SkillsScreen }))
);
const TraitsScreen = lazy(() =>
  import("@/components/screens/TraitsScreen").then((m) => ({ default: m.TraitsScreen }))
);
const ExportScreen = lazy(() =>
  import("@/components/screens/ExportScreen").then((m) => ({ default: m.ExportScreen }))
);
const StatsScreen = lazy(() =>
  import("@/components/screens/StatsScreen").then((m) => ({ default: m.StatsScreen }))
);
const BuddyScreen = lazy(() =>
  import("@/components/screens/BuddyScreen").then((m) => ({ default: m.BuddyScreen }))
);
const LeaksScreen = lazy(() =>
  import("@/components/screens/LeaksScreen").then((m) => ({ default: m.LeaksScreen }))
);
const OnboardingScreen = lazy(() =>
  import("@/components/screens/OnboardingScreen").then((m) => ({ default: m.OnboardingScreen }))
);
const ZonesScreen = lazy(() =>
  import("@/components/screens/ZonesScreen").then((m) => ({ default: m.ZonesScreen }))
);
const AllRitualsScreen = lazy(() =>
  import("@/components/screens/AllRitualsScreen").then((m) => ({ default: m.AllRitualsScreen }))
);
const SettingsScreen = lazy(() =>
  import("@/components/screens/SettingsScreen").then((m) => ({ default: m.SettingsScreen }))
);
const HabitsScreen = lazy(() =>
  import("@/components/screens/HabitsScreen").then((m) => ({ default: m.HabitsScreen }))
);
const WeeklyReportScreen = lazy(() =>
  import("@/components/screens/WeeklyReportScreen").then((m) => ({ default: m.WeeklyReportScreen }))
);
const MonthlyReportScreen = lazy(() =>
  import("@/components/screens/MonthlyReportScreen").then((m) => ({
    default: m.MonthlyReportScreen,
  }))
);
const CalorieGoalScreen = lazy(() =>
  import("@/components/screens/CalorieGoalScreen").then((m) => ({ default: m.CalorieGoalScreen }))
);
const QuickEntryFAB = lazy(() =>
  import("@/components/QuickEntryFAB").then((m) => ({ default: m.QuickEntryFAB }))
);
...
export default function Home() {
  const { currentScreen, selectedContentId, isInitialized, isLoading, login, setIsLoading } =
    useAppStore();
  ...
  useEffect(() => {
    ...
    const initApp = async () => {
      ...
      try {
        ...
        const tgWebApp = (window as unknown as { Telegram?: { WebApp?: { initData?: string } } })
          .Telegram?.WebApp;
        ...
        if (!ok && typeof window !== "undefined") {
          const message = (window as unknown as { __leakfixerAuthError?: string })
            .__leakfixerAuthError;
  ...
  return (
    ...
    >
      ...
      {/* Main Content Area */}
      <div
        className="mx-auto w-full max-w-md flex-1 overflow-y-auto px-4"
        style={{
          paddingTop: "8px",
...
function AuthErrorScreen({ message }: { message: string }) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-md flex-1 flex-col justify-center space-y-4 px-4 py-8">
        <div
        ...
        >
          ...
          <h1 className="mb-1 text-xl font-semibold text-white">LeakFixer</h1>
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            {canUseDemo && (
              <Button
                ...
                className="rounded-xl border-white/10 bg-white/5 text-sm text-white/50 hover:bg-white/10"
              >
                Демо-режим
              </Button>
            )}
...
function LoadingScreen() {
  return (
    ...
    >
      <div className="mx-auto max-w-md flex-1 space-y-4 px-4 py-8">
        ...
        <p className="animate-pulse text-center text-sm text-white/40">LeakFixer...</p>
      </div>
    </main>
  );
}
