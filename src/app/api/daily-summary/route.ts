  ...
  try {
    ...
    const checkin = {
      morning: {
        ...
        tasks: [
          morningCheckin?.task1 ?? null,
          morningCheckin?.task2 ?? null,
          morningCheckin?.task3 ?? null,
        ],
      ...
      evening: {
        ...
        tasksDone: [
          eveningCheckin?.task1Done ?? false,
          eveningCheckin?.task2Done ?? false,
          eveningCheckin?.task3Done ?? false,
        ],
      },
    };
    ...
    const checkinFlags = {
      isLowEnergy:
        (state.energy !== null && state.energy < 4) ||
        (morningCheckin?.energy !== undefined &&
          morningCheckin.energy !== null &&
          morningCheckin.energy <= 3),
      isBadMood:
        (state.mood !== null && state.mood < 4) ||
        (eveningCheckin?.dayRating !== undefined &&
          eveningCheckin.dayRating !== null &&
          eveningCheckin.dayRating <= 3),
    };
