...
import { formatDateKey, getDayOfWeek, normalizeToDate, parseDateKey } from "@/lib/date-utils";
  ...
  try {
    ...
    return NextResponse.json({
      ...
      stats: {
        ...
        percentage:
          todayRituals.length > 0 ? Math.round((completedCount / todayRituals.length) * 100) : 0,
      },
      rituals: ritualsData,
      todayRituals,
    });
