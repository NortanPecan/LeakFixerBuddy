...
const LEAK_TEMPLATES: Record<
  string,
  { name: string; duration: number; zone: string; type: string; config: Record<string, unknown> }
> = {
  no_gym: {
    name: "10 тренировок за месяц",
    duration: 30,
    zone: "health",
    type: "tracker",
  ...
  high_spend_days: {
    name: "Месяц финансовой дисциплины",
    duration: 30,
    zone: "savings",
    type: "custom",
