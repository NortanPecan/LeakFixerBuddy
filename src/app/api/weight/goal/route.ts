...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (weightDeadline !== undefined)
      updateData.weightDeadline = weightDeadline ? new Date(weightDeadline) : null;
    if (weightStartAt !== undefined)
      updateData.weightStartAt = weightStartAt ? new Date(weightStartAt) : null;
