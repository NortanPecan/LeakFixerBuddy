...
export function calculateActivityCalories(activity: ActivityEntry, weightKg: number = 70): number {
...
export function calculateTotalBurned(activities: ActivityEntry[], weightKg: number = 70): number {
...
export function normalizeSupplement(supplement: Partial<Supplement>): Supplement {
  ...
  return {
    ...
    standardDailyDose:
      Number(supplement.standardDailyDose) > 0
...
export function isDateInSupplementInterval(supplement: Supplement, dateKey: DateKey): boolean {
...
export function buildPlannedIntakes(supplement: Supplement, dateKey: DateKey): SupplementIntake[] {
